...
class MazeSolver:
    ...
    def get_neighbors(
        ...
        for dx, dy, md in MOVE_DIRECTION:
            ...
            # the car is moving forward or backwards
            if md == direction:  # if the new direction == md
                ...
                if direction == Direction.NORTH and md == Direction.EAST:
                    ...
                    # forward right case
                    # Check for valid position
                    bigger_change = coord_change_wrt_turn["FR"][0]
                    smaller_change = coord_change_wrt_turn["FR"][1]
                    ...
                    # backward left case
                    # Check for valid position
                    bigger_change = coord_change_wrt_turn["BL"][0]
                    smaller_change = coord_change_wrt_turn["BL"][1]
                    if self.grid.reachable(
                ...
                if direction == Direction.EAST and md == Direction.NORTH:
                    ...
                    # forward left case
                    # Check for valid position
                    bigger_change = coord_change_wrt_turn["FL"][0]
                    smaller_change = coord_change_wrt_turn["FL"][1]
                    if self.grid.reachable(
                        x + smaller_change, y + bigger_change, turn=True
                    ) and self.grid.reachable(x, y, preTurn=True):
                        safe_cost = self.get_safe_cost(
                    ...
                    # backward right case
                    # Check for valid position
                    bigger_change = coord_change_wrt_turn["BR"][0]
                    smaller_change = coord_change_wrt_turn["BR"][1]
                    if self.grid.reachable(
                        x - bigger_change, y - smaller_change, turn=True
                    ) and self.grid.reachable(x, y, preTurn=True):
                        safe_cost = self.get_safe_cost(
